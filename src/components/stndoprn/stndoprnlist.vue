  ...
  <v-data-table :headers="headers" :items="sawflags.items" dense  class="elevation-1"  :search="search"
    ...
    <template v-slot:top >
        ...
        <v-toolbar flat dark dense color="blue darken-4">
            <v-toolbar-title>StandardOperations</v-toolbar-title>
      ...
      editedIndex: -1, sawflags:[],// inputRules:[v=>v.length>=3||'Min len is 3 chars'],
              ...
              // { text: 'Select', value: 'action', sortable: false , width:"1%"},
               //{ text: 'Details', value: 'action', sortable: false , width:"1%"},
                { text: 'OrganizationId', align: 'left',  value: 'OrganizationId', width:"1%"},
              { text: 'OperationType', align: 'left',  value: 'OperationType', width:"1%"},
                 { text: 'StandardOperationCode', align: 'left',  value: 'StandardOperationCode', width:"1%"},
                  { text: 'WorkAreaCode', align: 'left',  value: 'WorkAreaCode', width:"1%"},
               { text: 'WorkCenterCode', align: 'left',  value: 'WorkCenterCode', width:"1%"},
                
              
               { text: 'OrganizationIdMfg', value: 'OrganizationIdMfg', sortable: false , width:"1%"},
...
//------------------------------------
          ...
          //----------------------------------
            ...
            this.loading=true;
             ...
             axios.get(`/take5/getstndoprn?offset=${e.pageStart}`,
             //{params:{'per_page':e.itemsPerPage}}
             )
                    .then((res) => { console.log('pagi-getstndoprn response',res.data.items)  
              ...
              if(x.length>2){ this.loading=true;
                 //axios.get(`${axios.defaults.baseURL}/take5/getjobs?search=${x}`)
                  axios.get(`/take5/getstndoprn?search=${x}`)
